...
```sh
git clone git@github.com:Andurdur/Chroma-Subsampling-Image-Compressor.git
cd Chroma-Subsampling-Image-Compressor
```
...
#### Commit your changes
```sh
git commit -m 'Starting Chroma-Subsampling-Image-Compressor'
